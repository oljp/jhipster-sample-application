...
public class SelDTO implements Serializable {
    ...
    private Set<DistinctEventDTO> distinctEvents = new HashSet<>();
    ...
    public Set<DistinctEventDTO> getDistinctEvents() {
        return distinctEvents;
    }

    public void setDistinctEvents(Set<DistinctEventDTO> distinctEvents) {

...
public class DistinctEventDTO implements Serializable {
    ...
    private Set<SelDTO> initiatingSels = new HashSet<>();

    private Set<SelDTO> associatedSels = new HashSet<>();
    ...
    public Set<SelDTO> getInitiatingSels() {
        return initiatingSels;
    }

    public void setInitiatingSels(Set<SelDTO> sels) {
        this.initiatingSels = sels;
    }

    public Set<SelDTO> getAssociatedSels() {
        return associatedSels;
    }

    public void setAssociatedSels(Set<SelDTO> sels) {

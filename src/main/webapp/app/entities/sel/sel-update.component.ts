...
export class SelUpdateComponent implements OnInit {
  ...
  updateForm(sel: ISel): void {
    this.editForm.patchValue({
      ...
      name: sel.name,
      rhel: sel.rhel,
      initiatingEvents: sel.initiatingEvents,
      associatedEvents: sel.associatedEvents
    });
  }
  ...
  private createFromForm(): ISel {
    return {
      ...
      initiatingEvents: this.editForm.get(['initiatingEvents'])!.value,
      associatedEvents: this.editForm.get(['associatedEvents'])!.value
    };
  }
